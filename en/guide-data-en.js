window.betaGuideData = {
    ...
    "prusa-mk3s": {
        ...
        description: "The Prusa MK3S is a reliable all-round printer. This redesign guide presents the most important workflows in a calmer layout.",
    ...
    "prusa-mk4": {
        ...
        description: "The MK4 guide covers filament loading and print start in the same visual system as the rest of the redesign.",
    ...
    "prusa-xl": {
        ...
        description: "The Prusa XL has multiple tools and more options. This redesign guide makes filament and print start workflows more manageable.",
    ...
    "laser-aeon": {
        ...
        description: "A short AEON guide to correct focus and the auto-focus function, in the same redesign style as the rest of the guides.",
    ...
    "laser-epilog": {
        ...
        description: "The Epilog guide is not yet available, but the redesign reserves the space in the same design style as the rest of the site.",
    ...
    "brother-scanncut": {
        ...
        description: "The original Brother Scan'n'Cut page is currently empty. The redesign prepares a styled placeholder in the same design style.",
    ...
    "canvasworkspace": {
        ...
        description: "CanvasWorkspace is split into two workflows: importing an SVG and tracing an image. The redesign layout makes the difference between them clearer.",
                        ...
                        items: [
                            {
                                ...
                                description: "Product data sheet with temperature, press time, pressure, Hot Peel and technical specifications."
                            }
                        ]
                    },
                    {
