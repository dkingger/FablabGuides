window.betaGuideData = {
    ...
    "prusa-mk3s": {
        ...
        description: "Prusa MK3S er en solid allround-printer. Redesign-guiden samler de vigtigste arbejdsgange i et roligere layout.",
    ...
    "prusa-mk4": {
        ...
        description: "MK4-guiden samler load af filament og printstart i samme visuelle system som resten af redesign-universet.",
    ...
    "prusa-xl": {
        ...
        description: "Prusa XL har flere værktøjer og flere valgmuligheder. Redesign-guiden gør workflows med filament og printstart mere overskuelige.",
    ...
    "laser-aeon": {
        ...
        description: "En kort AEON-guide til korrekt fokus og auto focus-funktionen, samlet i samme redesign-design som resten af guiderne.",
    ...
    "laser-epilog": {
        ...
        description: "Epilog-guiden er endnu ikke udfyldt i den oprindelige version, men redesignen reserverer allerede pladsen i samme designlinje som resten af sitet.",
    ...
    "brother-scanncut": {
        ...
        description: "Den oprindelige side for Brother Scan'n'Cut er tom i repoet lige nu. Redesignen viser derfor en forberedt, stylet plads til guiden.",
    ...
    "canvasworkspace": {
        ...
        description: "CanvasWorkspace er delt op i to workflows: import af SVG og sporing af et billede. Redesign-layoutet gør forskellen mellem dem tydeligere.",
